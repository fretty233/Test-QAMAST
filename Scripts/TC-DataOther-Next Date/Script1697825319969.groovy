...
Mobile.tap(findTestObject('Obj_DataPrimary/android.widget.ImageView - Next Month'), 0)

Mobile.tap(findTestObject('Obj_DataPrimary/android.widget.TextView - 1'), 0)
...
Mobile.tap(findTestObject('Obj_DataPrimary/android.widget.TextView - Other'), 0)

Mobile.setText(findTestObject('Object Repository/Obj_DataPrimary/android.widget.EditText - Input Description'), 'Testing 4', 
    0)

Mobile.tap(findTestObject('Obj_DataPrimary/android.widget.TextView - icon upload'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Obj_DataPrimary/android.widget.ImageView- image'), 0)

Mobile.tap(findTestObject('Object Repository/Obj_DataPrimary/android.widget.Button BTN Add Todo'), 0)

Mobile.tap(findTestObject('Obj_DataPrimary/android.widget.TextView - Home'), 0)

Mobile.tap(findTestObject('Obj_DataPrimary/android.view.ViewGroup'), 0)
